...
/////////////////                                    /////////////////
//       https://codesandbox.io/s/zpdu6?file=/src/api.json          //
//////////////////////////////////////////////////////////////////////
//THIS VERSION IS MISSING IMAGE REPLACEMENT
//LAST UPDATE 8/22/2021 in README
...
function toggleVisual(buttonClicked) {
  ...
  if (buttonClicked === "editFeaturedToggleBtn") editFeaturedCharacter();
}
